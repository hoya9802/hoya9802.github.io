...
### 문제 출처
[level 2] 멀쩡한 사각형 - Programmers ([문제 링크](https://school.programmers.co.kr/learn/courses/30/lessons/62048){:target="_blank"})
...
```
구현 자체는 어렵지 않지만 시간복잡도 해결을 위해 수학적 사고가 필요한 문제였습니다.