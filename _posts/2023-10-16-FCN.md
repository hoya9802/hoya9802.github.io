...
Convolution network는 물체 인식에서 발전을 주도하고 있으며, Convnet는 whole-image에 대한 classification를 향상시킬 뿐만 아니라 structed ouput의 local task에서도 전진을 이루고 있습니다.

Course에서 fine으로의 추론하는 과정에서 다음 단계는 every pixel에 대한 예측을 하는 것입니다.